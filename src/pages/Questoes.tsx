...
import { BookOpen, CheckCircle2, XCircle, Search, Filter, ChevronDown, ChevronUp, RotateCcw } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1 max-w-md">
          ...
          <Input
            placeholder="Buscar por matéria, assunto, banca..."
            className="pl-9 bg-card border-0 shadow-sm"
            value={searchTerm}
            onChange={(e) => setSearchTerm(e.target.value)}
          />
        </div>
        <Button variant="outline" className="bg-card border-0 shadow-sm gap-2">
      ...
      <div className="flex gap-4 text-sm">
        <span className="text-muted-foreground">{questoes.length} questões</span>
